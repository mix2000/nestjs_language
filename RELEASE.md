# Release Guide v0.0.9

## ✅ Релиз подготовлен!

### Что сделано:
- ✅ Версия обновлена до **0.0.9** в package.json
...
npm install ozma-nestjs-language@0.0.9
```
...
### Критическое исправление v0.0.9:
...
- ✅ Версия в package.json уникальна (0.0.9 еще не опубликована)
